## 接口描述
DeregisterInstancesFromForwardLB 接口用来将一台或多台云服务器从应用型负载均衡的七层监听器的转发规则上解绑。
...
|backends.n.eniIp|否|string|云服务器绑定弹性网卡的ip地址，包括主网卡主 IP，主网卡辅助 IP，辅助网卡主 IP 和辅助网卡辅助 IP；<br>此接口支持同时输入多个 IP 地址（如：要输入2个 IP，则设置 backends.0.eniIp&backends.1.eniIp）。<br>每个 backends 只能设置 instanceId 或 eniIp。|
